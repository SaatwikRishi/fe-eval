...
describe('Tests for Home Body', () => {
  ...
  it('should display loading on screen', () => {
    makeRequest.mockResolvedValue({ data: { success: false } })
  ...
  it('should render the elements when everything is fine', async () => {
    makeRequest.mockResolvedValue([
      {
        id: 1,
        name: 'Battle of the Bands',
    ...
    await waitFor(() => {
      expect(screen.getByText('Wicked the Musical')).toBeTruthy()
    })
  })
})
